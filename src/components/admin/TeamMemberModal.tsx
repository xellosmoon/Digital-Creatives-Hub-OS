      ...
      <div className="bg-white dark:bg-slate-800 rounded-lg max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-5 flex-1">
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-slate-900 dark:border-slate-600 dark:text-white dark:placeholder-slate-400"
              required
            />
          </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <button
                ...
                className="inline-flex items-center px-2 py-1 text-xs font-medium text-primary-600 hover:text-primary-700 hover:bg-primary-50 dark:hover:bg-primary-900/30 rounded"
              >
            ...
            <div className="space-y-3">
              {form.designations.map((des, index) => (
                <div key={index} className="p-3 border border-gray-200 dark:border-slate-700 rounded-lg bg-gray-50 dark:bg-slate-900">
                  <div className="flex items-start gap-2">
                    <div className="flex-1 space-y-2">
                      <input
                        ...
                        className="w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 text-sm dark:bg-slate-800 dark:border-slate-600 dark:text-white dark:placeholder-slate-400"
                      />
                      <input
                        type="text"
                    ...
                    {form.designations.length > 1 && (
                      <button
                        ...
                        className="mt-1 p-1.5 text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-900/20 rounded"
                        title="Remove"
                      >
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">Add all positions this person holds across different organizations.</p>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-slate-900 dark:border-slate-600 dark:text-white dark:placeholder-slate-400"
            />
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Optional. 2-3 sentences recommended.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-slate-900 dark:border-slate-600 dark:text-white dark:placeholder-slate-400"
              />
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Optional. Displayed on About Us page.</p>
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                Email Address
          ...
          <div>
            ...
            <div className="space-y-3">
              {/* File Upload Button */}
              <div>
                <label className="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 cursor-pointer dark:border-slate-600 dark:text-gray-300 dark:bg-slate-800 dark:hover:bg-slate-700">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Max 2MB. JPG, PNG, or WebP.</p>
              </div>
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="px-2 bg-white dark:bg-slate-800 text-gray-500 dark:text-gray-400">or paste URL</span>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* Featured Toggle */}
            <div>
              <label className="flex items-center gap-2 cursor-pointer p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors dark:border-slate-700 dark:hover:bg-slate-700">
                <input
                  type="checkbox"
                  checked={form.is_featured}
                  onChange={(e) => updateField('is_featured', e.target.checked)}
                  className="h-4 w-4 text-amber-600 focus:ring-amber-500 border-gray-300 rounded dark:border-slate-600 dark:bg-slate-900"
                />
                <div className="flex-1">
                  <div className="flex items-center gap-1.5">
                    <Star className="w-4 h-4 text-amber-500" />
                    <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Featured Member</span>
                  </div>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Display at top with larger card</p>
                </div>
              </label>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-slate-900 dark:border-slate-600 dark:text-white"
              />
        ...
        <div className="px-6 py-4 border-t border-gray-200 dark:border-slate-700 flex justify-between flex-shrink-0">
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50 dark:border-slate-600 dark:text-gray-300 dark:hover:bg-slate-700"
          >
            Cancel
          </button>
          <button
