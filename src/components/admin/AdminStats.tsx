    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {quickStats.map((stat, index) => {
          ...
          return (
            <div key={index} className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 p-5 hover:shadow-md transition-shadow">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 p-5">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-sm font-bold text-gray-900 dark:text-white">Top Organizations</h3>
          </div>
          {analytics.topOrganizations.length > 0 ? (
            <div className="space-y-2">
              {analytics.topOrganizations.slice(0, 5).map((org, index) => (
                <div key={index} className="flex items-center justify-between">
                  <span className="text-sm text-gray-700 dark:text-gray-300 truncate flex-1 mr-2">{org.name}</span>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 p-5">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-sm font-bold text-gray-900 dark:text-white">Top Creative Domains</h3>
          </div>
          {analytics.pcidaBreakdown.length > 0 ? (
            <div className="space-y-2">
              {analytics.pcidaBreakdown.slice(0, 5).map((item, index) => (
                <div key={index} className="flex items-center justify-between">
                  <span className="text-sm text-gray-700 dark:text-gray-300 truncate flex-1 mr-2">{item.domain}</span>
                  <span className="text-xs font-semibold text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-slate-700 px-2 py-0.5 rounded-full">
                    {item.count}
                  </span>
                </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 p-5">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-sm font-bold text-gray-900 dark:text-white">Visit Purposes</h3>
          </div>
          {analytics.purposeBreakdown.length > 0 ? (
            <div className="space-y-2">
              {analytics.purposeBreakdown.slice(0, 5).map((item, index) => (
                <div key={index} className="flex items-center justify-between">
                  <span className="text-sm text-gray-700 dark:text-gray-300 truncate flex-1 mr-2">{item.purpose}</span>
                  <span className="text-xs font-semibold text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-slate-700 px-2 py-0.5 rounded-full">
                    {item.count}
                  </span>
                </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 p-5">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-sm font-bold text-gray-900 dark:text-white">Last 7 Days</h3>
          </div>
              ...
              {analytics.dailyVisitors.map((day, index) => {
                ...
                return (
                  <div key={index} className="flex-1 flex flex-col items-center gap-1">
                    <span className="text-xs font-medium text-gray-600 dark:text-gray-300">{day.count}</span>
                    <div
