      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left">
          ...
          <a
            ...
            className="group inline-flex items-center gap-2.5 text-xs text-white/60 hover:text-white transition-colors"
          >
            <img
            ...
            <span className="leading-tight text-left">
              Made by{' '}
              <span className="font-semibold text-[#F59E0B] tracking-wide group-hover:text-white transition-colors">
